...
public class TestCache 
{
    ...
    public static void testLru5() throws Exception
    {
        ...
        // Nikhil Start
        String target_dir = "/home/anish/Desktop/Spring-2015/OS/Tweets";
        ...
        while (entry != null) {
            ...
            // read the record into a tree model,
                          ...
                          //  System.out.println(node.getValueAsText());
                            cache.addObject(node.getValueAsText(), new Integer(1));
                            cache_lfu.addObject(node.getValueAsText(), new Integer(1));
                            cache_fifo.addObject(node.getValueAsText(), new Integer(1));
                        }
                    } else {
